...
// returns snake
std::deque<Point> GameBoard::return_snake()
{
    return snake_;
}

// returns snakes heads X coordinate
int GameBoard::get_x()
{
    return snake_.back().return_x();
}

// returns snakes heads y coordinate
int GameBoard::get_y()
{
    return snake_.back().return_y();
}

// returns foods X coordinate
int GameBoard::return_foodX()
{
    return food_.return_x();
}

// returns foods y coordinate
int GameBoard::return_foodY()
{
    return food_.return_y();
}

// returns true if snake is dead
bool GameBoard::death()
{
    if (dead_){
        return true;
    }
